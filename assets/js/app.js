...
/* harmony import */ var _modules_PageHeader__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/PageHeader */ "./src/assets/js/modules/PageHeader.js");
/* harmony import */ var _modules_PageHeader__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_modules_PageHeader__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _modules_Slider__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/Slider */ "./src/assets/js/modules/Slider/index.js");
/* harmony import */ var _modules_PickupTabs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/PickupTabs */ "./src/assets/js/modules/PickupTabs.js");
/* harmony import */ var _modules_Map__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/Map */ "./src/assets/js/modules/Map/index.js");
/* harmony import */ var _modules_PickupPoint__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/PickupPoint */ "./src/assets/js/modules/PickupPoint/index.js");
/* harmony import */ var _modules_Select__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/Select */ "./src/assets/js/modules/Select/index.js");
/* harmony import */ var _modules_Contacts__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/Contacts */ "./src/assets/js/modules/Contacts/index.js");
/* harmony import */ var _modules_Tooltip__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/Tooltip */ "./src/assets/js/modules/Tooltip/index.js");
/* harmony import */ var _popperjs_core__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @popperjs/core */ "./node_modules/@popperjs/core/lib/index.js");
...
/***/ "./src/assets/js/modules/Map/HtmlMapMarker.js":
/*!****************************************************!*\
  !*** ./src/assets/js/modules/Map/HtmlMapMarker.js ***!
  \****************************************************/
/*! exports provided: default */
...
var createHTMLMapMarker = function createHTMLMapMarker(_ref) {
  ...
  function (_OverlayView) {
    ...
    function HTMLMapMarker() {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(HTMLMapMarker).call(this));
...
/***/ "./src/assets/js/modules/Map/MarkerTemplate.js":
/*!*****************************************************!*\
  !*** ./src/assets/js/modules/Map/MarkerTemplate.js ***!
  \*****************************************************/
/*! exports provided: generateMarkerTemplate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/assets/js/modules/Map/index.js":
/*!********************************************!*\
  !*** ./src/assets/js/modules/Map/index.js ***!
  \********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _HtmlMapMarker__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./HtmlMapMarker */ "./src/assets/js/modules/Map/HtmlMapMarker.js");
/* harmony import */ var _MarkerTemplate__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./MarkerTemplate */ "./src/assets/js/modules/Map/MarkerTemplate.js");
/* harmony import */ var _data_pickupCoords_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../data/pickupCoords.json */ "./src/data/pickupCoords.json");
var _data_pickupCoords_json__WEBPACK_IMPORTED_MODULE_2___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../../../data/pickupCoords.json */ "./src/data/pickupCoords.json", 1);
...
/***/ "./src/assets/js/modules/PageHeader.js":
/*!*********************************************!*\
  !*** ./src/assets/js/modules/PageHeader.js ***!
  \*********************************************/
/*! no static exports found */
...
/***/ "./src/assets/js/modules/PickupPoint/index.js":
/*!****************************************************!*\
  !*** ./src/assets/js/modules/PickupPoint/index.js ***!
  \****************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _data_pickupCoords_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../../data/pickupCoords.json */ "./src/data/pickupCoords.json");
var _data_pickupCoords_json__WEBPACK_IMPORTED_MODULE_0___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../../../data/pickupCoords.json */ "./src/data/pickupCoords.json", 1);
/* harmony import */ var _Map__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Map */ "./src/assets/js/modules/Map/index.js");
...
/***/ "./src/assets/js/modules/PickupTabs.js":
/*!*********************************************!*\
  !*** ./src/assets/js/modules/PickupTabs.js ***!
  \*********************************************/
/*! no exports provided */
...
/* harmony import */ var _data_pickupCoords_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../data/pickupCoords.json */ "./src/data/pickupCoords.json");
var _data_pickupCoords_json__WEBPACK_IMPORTED_MODULE_1___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../../../data/pickupCoords.json */ "./src/data/pickupCoords.json", 1);
/* harmony import */ var _Map__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Map */ "./src/assets/js/modules/Map/index.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (tabsContainer) {
    var tabs = new tabbyjs__WEBPACK_IMPORTED_MODULE_0___default.a('[data-tabs] ul');
    tabs.toggle('#boxBerry');
  }
});
document.addEventListener('tabby', function (event) {
  var content = event.detail.content;
  var selector = content.querySelector('.accordion');
  var currentCity = content.querySelector('input:checked') && content.querySelector('input:checked').dataset.id;
  var map = content.querySelector('.map');
  var currentCoords = _data_pickupCoords_json__WEBPACK_IMPORTED_MODULE_1__[content.id];
  if (!selector && !currentCity && !currentCoords) return;
  Object(_Map__WEBPACK_IMPORTED_MODULE_2__["default"])(map, currentCoords[currentCity].coords);
  selector.addEventListener('change', function (e) {
    Object(_Map__WEBPACK_IMPORTED_MODULE_2__["default"])(map, currentCoords[e.target.dataset.id].coords);
  });
}, false);

/***/ }),

/***/ "./src/assets/js/modules/Select/Select.js":
/*!************************************************!*\
  !*** ./src/assets/js/modules/Select/Select.js ***!
  \************************************************/
...
var getTemplate = function getTemplate() {
  ...
  var items = data.map(function (item) {
    ...
    return "\n      <li class=\"select__item ".concat(cls, "\" data-type=\"item\" data-id=\"").concat(item.id, "\" data-name=\"").concat(item.value, "\">").concat(item.name, "</li>\n    ");
  });
...
function () {
  function Select(el, options) {
    ...
    this.options = options; // this.selectedId = options.selectedId
  ...
  _createClass(Select, [{
    ...
    value: function render() {
      this.data = Array.from(this.$el.firstElementChild.options).map(function (item, i) {
        return {
          id: i,
          value: item.value,
      ...
      var placeholder = this.data.shift().name;
      var selected = this.data.filter(function (item) {
        return item.selected;
      })[0];
      this.selectedId = selected ? selected.id : '0';
      this.$el.classList.add('select');
      this.$el.innerHTML = getTemplate(this.data, placeholder, this.selectedId); // if (this.options) {
...
/***/ "./src/assets/js/modules/Select/index.js":
/*!***********************************************!*\
  !*** ./src/assets/js/modules/Select/index.js ***!
  \***********************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Select__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Select */ "./src/assets/js/modules/Select/Select.js");

document.querySelectorAll('.select').forEach(function (node) {
  new _Select__WEBPACK_IMPORTED_MODULE_0__["Select"](node);
});
...
var getTemplate = function getTemplate() {
  ...
  var items = data.map(function (item) {
    ...
    return "\n      <li class=\"select__item ".concat(cls, "\" data-type=\"item\" data-id=\"").concat(item.id, "\" data-name=\"").concat(item.name, "\">").concat(item.value, "</li>\n    ");
  });
  return "\n    <div class=\"select__backdrop\" data-type=\"backdrop\"></div>\n    <div class=\"select__field\" data-type=\"input\">\n      <span data-type=\"value\">".concat(text, "</span>\n      <i class=\"fa fa-chevron-down\" data-type=\"arrow\"></i>\n    </div>\n    <div class=\"select__dropdown\">\n      <ul class=\"select__list\">\n        ").concat(items.join(''), "\n      </ul>\n    </div>\n  ");
}; // export class Select {
...
document.addEventListener('DOMContentLoaded', function () {// new Slider({ target: '#example-slider', settings: {
  //     slidesPerView: 1,
  //     spaceBetween: 1
  //   }});
  //
...
var dataSlider = document.querySelectorAll('[data-slider]');
...
/***/ "./src/assets/js/modules/Tooltip/index.js":
/*!************************************************!*\
  !*** ./src/assets/js/modules/Tooltip/index.js ***!
  \************************************************/
/*! no exports provided */
...
/***/ "./src/data/pickupCoords.json":
/*!************************************!*\
  !*** ./src/data/pickupCoords.json ***!
  \************************************/
/*! exports provided: boxBerry, iml, hermes, kce, default */
/***/ (function(module) {

module.exports = {"boxBerry":{"vladivostok":{"coords":[{"lat":"43.1488997","lng":"131.9090131"},{"lat":"43.1592569","lng":"131.9147171"}]},"ussurysk":{"coords":[{"lat":"43.7871186","lng":"131.9041227"},{"lat":"43.7871186","lng":"131.9458522"}]},"nakhodka":{"coords":[{"lat":"42.8159784","lng":"132.8675748"},{"lat":"42.8094144","lng":"132.8691754"}]}},"iml":{"vladivostok":{"coords":[{"lat":"43.1488997","lng":"131.9090131"},{"lat":"43.1592569","lng":"131.9147171"}]},"ussurysk":{"coords":[{"lat":"43.7871186","lng":"131.9041227"},{"lat":"43.7871186","lng":"131.9458522"}]},"nakhodka":{"coords":[{"lat":"42.8159784","lng":"132.8675748"},{"lat":"42.8094144","lng":"132.8691754"}]}},"hermes":{"vladivostok":{"coords":[{"lat":"43.1488997","lng":"131.9090131"},{"lat":"43.1592569","lng":"131.9147171"}]},"ussurysk":{"coords":[{"lat":"43.7871186","lng":"131.9041227"},{"lat":"43.7871186","lng":"131.9458522"}]},"nakhodka":{"coords":[{"lat":"42.8159784","lng":"132.8675748"},{"lat":"42.8094144","lng":"132.8691754"}]}},"kce":{"vladivostok":{"coords":[{"lat":"43.1488997","lng":"131.9090131"},{"lat":"43.1592569","lng":"131.9147171"}]},"ussurysk":{"coords":[{"lat":"43.7871186","lng":"131.9041227"},{"lat":"43.7871186","lng":"131.9458522"}]},"nakhodka":{"coords":[{"lat":"42.8159784","lng":"132.8675748"},{"lat":"42.8094144","lng":"132.8691754"}]}}};
...
module.exports = __webpack_require__(/*! /Users/nekki/projects/bus-curier/src/assets/js/app.js */"./src/assets/js/app.js");
